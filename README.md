About darabonba-core-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/darabonba-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/darabonba-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add darabonba-core
# for installing globally
pixi global install darabonba-core
```
...
It is possible to list all of the versions of `darabonba-core` available on your platform:
...
```
pixi search darabonba-core --channel conda-forge
```
